...
base_url = 'https://cse.google.com/cse?cx=a3240aae15a61423c#gsc.tab=0&gsc.q=connect&gsc.sort='
visited_links = set()
    ...
    for link in soup.find_all('a'):
        ...
        if href:
            ...
            if parsed_href.scheme == 'http' or parsed_href.scheme == 'https':
                if parsed_href.netloc == urlparse(base_url).netloc and href not in visited_links:
                    links.append(href)
    ...
    for script in soup.find_all('script'):
        ...
        if src:
            ...
            if parsed_src.netloc == '':
                ...
                parsed_src = urlparse(src)
            if parsed_src.scheme == 'http' or parsed_src.scheme == 'https':
                if parsed_src.netloc == urlparse(base_url).netloc and src not in visited_links:
                    links.append(src)
